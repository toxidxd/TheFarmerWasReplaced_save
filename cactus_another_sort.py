...
def PlantCactus():
    ...
    while get_entity_type() != Entities.Cactus:
        ...
        if get_pos_x() + get_pos_y() > get_world_size() * 1.3 and measure() >= 6:
            pass
        elif get_pos_x() + get_pos_y() <= get_world_size() * 1.3 and get_pos_x() + get_pos_y() >= get_world_size() * 0.7 and measure() >= 3 and measure() <= 6:
            pass
        elif get_pos_x() + get_pos_y() < get_world_size() * 0.7 and measure() <= 3:
            pass
        else:
            till()
            till()
...
while num_items(Items.Cactus) < 9999999999:
